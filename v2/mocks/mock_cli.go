...
// Source: github.com/robgonnella/ardi/v2/cli-wrapper (interfaces: Client)
...
func (m *MockClient) AllBoards() []*cli.Board {
	m.ctrl.T.Helper()
...
func (m *MockClient) Compile(arg0 cli.CompileOpts) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) ConnectedBoards() []*cli.Board {
	m.ctrl.T.Helper()
